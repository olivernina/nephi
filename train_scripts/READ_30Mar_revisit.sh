...
python crnn_main.py --crnn experiments/expr_READ_30Mar_revisit/netCRNN_5_4184.pth --trainroot /deep_data/nephi/data/lmdb_read_new/train --valroot /deep_data/nephi/data/lmdb_read_new/val --cuda --lr 0.0001 --displayInterval 120 --valEpoch 5 --saveEpoch 5 --workers 10 --niter 200 --experiment experiments/expr_READ_30Mar_revisit --keep_ratio --imgH 60 --imgW 240 --batchSize 2 >> log_ICFHR_30Mar_read_revisit.txt
